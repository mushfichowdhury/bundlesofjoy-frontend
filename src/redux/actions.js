...
export function userLoginAction(user, dispatch) {
    return function(){
        ...
        fetch('https://bundles-of-joy.herokuapp.com/api/v1/login', config)
...
export function getDiapers(){
    return function(dispatch) {
        fetch("https://bundles-of-joy.herokuapp.com/api/v1/diapers")
		.then(resp => resp.json())
...
export function getFeedings() {
    return function (dispatch) {
    fetch('https://bundles-of-joy.herokuapp.com/api/v1/feedings')
        .then(resp => resp.json())
...
export function getNaps() {
    return function (dispatch) {
    fetch('https://bundles-of-joy.herokuapp.com/api/v1/naps')
        .then(resp => resp.json())
...
export function getEntries() {
    return function (dispatch) {
    fetch('https://bundles-of-joy.herokuapp.com/api/v1/journal_entries')
        .then(resp => resp.json())
...
export function getChildren() {
    return function (dispatch) {
    fetch('https://bundles-of-joy.herokuapp.com/api/v1/children')
        .then(resp => resp.json())
...
export function editDiaperChange(editedDiaperChange) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/diapers/${editedDiaperChange.id}`, {
        method: "PATCH",
        headers: {
        "content-type": "application/json",
        accepts: "application/json"
...
export function deleteDiaperChange(diaperObj) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/diapers/${diaperObj}`, {
        method: "DELETE",
    })
        .then(resp => resp.json())
...
export function editFeeding(editedFeeding) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/feedings/${editedFeeding.id}`, {
        method: "PATCH",
        headers: {
        "content-type": "application/json",
        accepts: "application/json"
...
export function editNap(editedNap) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/naps/${editedNap.id}`, {
        method: "PATCH",
        headers: {
        "content-type": "application/json",
        accepts: "application/json"
...
export function editEntry(editedEntry) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/journal_entries/${editedEntry.id}`, {
        method: "PATCH",
        headers: {
        "content-type": "application/json",
        accepts: "application/json"
...
export function deleteFeeding(feedingObj) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/feedings/${feedingObj}`, {
        method: "DELETE",
    })
        .then(resp => resp.json())
...
export function deleteNap(napObj) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/naps/${napObj}`, {
        method: "DELETE",
    })
        .then(resp => resp.json())
...
export function deleteEntry(entryObj) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/journal_entries/${entryObj}`, {
        method: "DELETE",
    })
        .then(resp => resp.json())
...
export function deleteChild(childObj) {
    return function (dispatch) {
    fetch(`https://bundles-of-joy.herokuapp.com/api/v1/children/${childObj}`, {
        method: "DELETE",
    })
        .then(resp => resp.json())
